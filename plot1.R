...
hist(d$Global_active_power1, col="red", breaks = 22, freq = FALSE, xlab = "Global Active Power (kilowatts)", ylab = "Frequency", main = "Global Active Power")
range(d$Global_active_power1, na.rm = TRUE)